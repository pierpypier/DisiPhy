...
J'ai lavé les serviettes de plage avec le reste du linge. (ʒé lavé le servièt de plaʒ avek le rest dü liñ) - Ho lavato gli asciugamani da spiaggia insieme al resto della biancheria.
Tu peux remettre les coussins sur le canapé ? (tü pö remetr le kusan sür le kanapé) - Puoi rimettere i cuscini sul divano?
J'ai laissé les clés de secours dans le tiroir du bureau. (ʒé lesé le clé de sekur dan le tirwar dü büro) - Ho lasciato le chiavi di riserva nel cassetto della scrivania.
Le four est encore chaud, fais attention en passant. (le fur é ankor sco, fè atansiòn an pasan) - Il forno è ancora caldo, fai attenzione passando.
Le chien gratte à la porte quand il veut sortir. (le scièn grat a la port kan il vö sortir) - Il cane gratta alla porta quando vuole uscire.
Notre chat revient toujours à la même heure le soir. (notr scia revien tuʒur a la mem ör le swar) - Il nostro gatto torna sempre alla stessa ora la sera.
J'ai mangé un yaourt parce que je n'avais plus très faim. (ʒé manʒé an iaur parskö ʒö navè plü trè fen) - Ho mangiato uno yogurt perché non avevo più molta fame.
Tu peux mettre les assiettes dans l'évier ? (tü pö metr le zasiet dan levié) - Puoi mettere i piatti nel lavello?
On a encore du riz d'hier, on peut le réchauffer. (on a ankor dü ri dier, on pö le rescofé) - Abbiamo ancora del riso di ieri, possiamo riscaldarlo.
J'ai préparé le dessert pendant que le dîner cuisait. (ʒé preparé le deser pandan ke le diné küizè) - Ho preparato il dolce mentre cuoceva la cena.
J'ai enfin terminé le devoir que je repoussais depuis plusieurs jours. (ʒé anfen terminé le devwar ke ʒö repusè döpüi plüzior ʒur) - Finalmente ho finito il compito che rimandavo da diversi giorni.
Le professeur a changé la date de l'examen. (le profesör a sciandʒé la dat de legzamen) - L'insegnante ha cambiato la data dell'esame.
Elle a choisi la biologie parce qu'elle aime comprendre comment fonctionne le corps. (el a scwazì la biyoloʒi parskel em komprandr koman fonksiòn le kor) - Ha scelto biologia perché le piace capire come funziona il corpo.
J'ai besoin d'une calculatrice pour terminer ce problème. (ʒé bezwan dün kalkülatris pur terminé se problem) - Ho bisogno di una calcolatrice per finire questo problema.
On a discuté de ce livre pendant toute la pause. (on a disküte de se livr pandan tut la poz) - Abbiamo parlato di questo libro per tutta la pausa.
Tu peux m'envoyer la photo du tableau ? (tü pö manvwaye la foto dü tablo) - Puoi mandarmi la foto della lavagna?
Je te laisse sortir, mais tu dois être rentré avant minuit. (ʒö te les sortir, mè tü dwa etr rantré avan minüi) - Ti lascio uscire, ma devi essere rientrato prima di mezzanotte.
Si tu as fini tes devoirs, tu peux rejoindre tes amis. (si tü a fini te devwar, tü pö reʒwèndr te zami) - Se hai finito i compiti, puoi raggiungere i tuoi amici.
J'ai besoin de savoir si tu rentres pour dîner. (ʒé bezwan de savwar si tü rantr pur diné) - Ho bisogno di sapere se torni per cena.
On garde le téléphone dans la chambre la nuit. (on gard le telefon dan la sciambre la nüi) - Di notte teniamo il telefono in camera.
J'ai pris rendez-vous parce que ma douleur ne disparaissait pas. (ʒé pri randé-vu parskö ma dulör ne disparèsè pa) - Ho preso un appuntamento perché il dolore non passava.
La pharmacienne m'a indiqué où trouver le médicament. (la farmasièn ma andike u truvé le medikaman) - La farmacista mi ha indicato dove trovare il farmaco.
Je tousse surtout quand je m'allonge. (ʒö tus sürtu kan ʒö malonʒ) - Tossisco soprattutto quando mi sdraio.
Le médecin a écouté ma respiration avant de m'examiner. (le medsan a ekuté ma respirasiòn avan de megzamine) - Il medico ha ascoltato la mia respirazione prima di visitarmi.
Je dois revenir la semaine prochaine pour un contrôle. (ʒö dwa revnir la semèn proscièn pur an kontrol) - Devo tornare la prossima settimana per un controllo.
J'ai regardé les horaires du train sur l'application. (ʒé regardé le zorèr dü tran sür laplikasiòn) - Ho guardato gli orari del treno sull'app.
Le train est annoncé voie numéro sept. (le tran é anonse vwa nümero set) - Il treno è annunciato al binario numero sette.
On a juste le temps de prendre un café avant le départ. (on a ʒüst le tan de prandr an kafé avan le depart) - Abbiamo giusto il tempo di prendere un caffè prima della partenza.
J'ai mis une alarme pour ne pas rater l'arrêt. (ʒé mi ün alarme pur ne pa raté larè) - Ho impostato una sveglia per non perdere la fermata.
La ligne de métro est directe depuis cette station. (la liñ de métro é direkt döpüi set stasiòn) - La linea della metropolitana è diretta da questa stazione.
Je descends ici, tu continues jusqu'à la prochaine station. (ʒö desan isi, tü kontinü ʒüsk a la proscièn stasiòn) - Io scendo qui, tu continui fino alla prossima stazione.
Il y a trop de monde dans cette rame. (il ia tro de mond dan set ram) - C'è troppa gente su questo convoglio.
J'ai dû attendre le tram suivant parce que celui-ci était plein. (ʒé dü atandr le tram süivan parskö selüi-si etè plen) - Ho dovuto aspettare il tram successivo perché questo era pieno.
Le bus s'est arrêté juste devant l'école. (le büs sé areté ʒüst devan lekol) - L'autobus si è fermato proprio davanti alla scuola.
Tu sais si ce bus va jusqu'à la gare ? (tü sè si se büs va ʒüsk a la gar) - Sai se questo autobus arriva fino alla stazione?
J'ai changé de place parce que le soleil me gênait. (ʒé sciandʒé de plas parskö le solèy me ʒenè) - Ho cambiato posto perché il sole mi dava fastidio.
Notre porte d'embarquement est à l'autre bout du terminal. (notr port danbarkman é a lotr bu dü terminal) - Il nostro gate d'imbarco è dall'altra parte del terminal.
J'ai rempli le formulaire avant de passer au contrôle des passeports. (ʒé ranpli le formulèr avan de pasé o kontrol de paspor) - Ho compilato il modulo prima di passare il controllo dei passaporti.
Le vol de retour est prévu dimanche soir. (le vol de retur é prevü dimansc swar) - Il volo di ritorno è previsto domenica sera.
On a attendu nos bagages près du tapis numéro trois. (on a atandü no bagàʒ prè dü tapi nümero trwa) - Abbiamo aspettato i nostri bagagli vicino al nastro numero tre.
Le bateau bouge beaucoup à cause des vagues. (le bato buʒ bokou a koz de vag) - Il traghetto si muove molto a causa delle onde.
J'ai acheté quelque chose à boire avant d'embarquer. (ʒé asciété kelkö scos a bwar avan danbarké) - Ho comprato qualcosa da bere prima di imbarcarmi.
Pour le centre-ville, prends cette avenue et reste toujours tout droit. (pur le santr-vil, pran set avenü é rest tuʒur tu drwa) - Per il centro, prendi questo viale e continua sempre dritto.
Je ne reconnais plus le quartier, tout a changé depuis ma dernière visite. (ʒö ne rekonè plü le kartié, tu a sciandʒé döpüi ma dernyèr vizit) - Non riconosco più il quartiere, è cambiato tutto dalla mia ultima visita.
J'ai oublié où j'avais garé la voiture. (ʒé oublié u ʒavè garé la vuatür) - Ho dimenticato dove avevo parcheggiato la macchina.
Le moteur démarre, mais il cale immédiatement. (le motor demar, mè il kal imediyatman) - Il motore parte, ma si spegne subito.
J'ai crevé en pleine campagne et il n'y avait personne autour. (ʒé krevé an plen kampañ é il niavè person otur) - Ho forato in piena campagna e non c'era nessuno nei dintorni.
Une ambulance est arrivée quelques minutes après l'appel. (ün anbilans é arivé kelk minüt aprè lapèl) - Un'ambulanza è arrivata pochi minuti dopo la chiamata.
La circulation est presque à l'arrêt sur cette route. (la sirkülasiòn é presk a larè sür set rut) - Il traffico è quasi completamente fermo su questa strada.
Le quartier a été évacué à cause d'une fuite de gaz. (le kartié a été evaküé a koz dün füit de gaz) - Il quartiere è stato evacuato a causa di una fuga di gas.
La climatisation de la chambre fait beaucoup de bruit. (la klimatizasiòn de la sciambre fè bokou de brüi) - L'aria condizionata della camera fa molto rumore.
J'ai demandé au réceptionniste de noter le problème. (ʒé demandé o resepsionist de noté le problem) - Ho chiesto al receptionist di annotare il problema.
On nous a proposé une autre chambre pour la nuit. (on nu a propozé ün otr sciambre pur la nüi) - Ci hanno proposto un'altra camera per la notte.
Notre appartement de vacances a une petite terrasse avec vue sur la ville. (notr apartman de vakans a ün pətit teras avek vü sür la vil) - Il nostro appartamento per le vacanze ha una piccola terrazza con vista sulla città.
J'ai dépoussiéré les étagères avant de ranger les livres. (ʒé depüsiere le zetajer avan de ranʒé le livr) - Ho spolverato gli scaffali prima di sistemare i libri.
Tu peux éteindre la lumière du couloir en passant ? (tü pö etandr la lümièr dü kuloir an pasan) - Puoi spegnere la luce del corridoio passando?
J'ai retrouvé les clés derrière le meuble de l'entrée. (ʒé retruvé le clé derrièr le möbl de lantré) - Ho ritrovato le chiavi dietro il mobile dell'ingresso.
La machine à laver s'est mise en pause toute seule. (la mascin a lavé sé mi an poz tut söl) - La lavatrice si è messa in pausa da sola.
Le chien aboie chaque fois que quelqu'un sonne à la porte. (le scièn abwa sciak fwa kelkan son a la port) - Il cane abbaia ogni volta che qualcuno suona alla porta.
Le vétérinaire a dit que le chat allait bien. (le veteriner a di ke le scia alè bièn) - Il veterinario ha detto che il gatto stava bene.
J'ai préparé des tartines avec du beurre et de la confiture. (ʒé preparé de tartin avek dü bör é de la konfityür) - Ho preparato delle fette di pane con burro e marmellata.
Tu veux encore un peu de café ou ça suffit ? (tü vö ankor an pö de kafé u sa süfi) - Vuoi ancora un po' di caffè o basta così?
On mangera les restes demain midi pour éviter de jeter. (on manʒra le rest döman midi pur evité de ʒeté) - Domani a pranzo mangeremo gli avanzi per evitare di buttarli.
J'ai mis le poulet au four, il sera prêt dans une demi-heure. (ʒé mi le pulè o fur, il sera prè dan ün dömi ör) - Ho messo il pollo in forno, sarà pronto tra mezz'ora.
J'ai relu le chapitre avant de répondre aux questions. (ʒé relü le scapitər avan de repond o kestiòn) - Ho riletto il capitolo prima di rispondere alle domande.
La prof de français nous a donné un texte à analyser. (la prof de fransè nu a doné an tekst a analizé) - La professoressa di francese ci ha dato un testo da analizzare.
J'ai eu du mal avec cet exercice de géométrie. (ʒé ü dü mal avek set egzèrsis de ʒeometri) - Ho avuto difficoltà con questo esercizio di geometria.
Elle doit apprendre cette poésie pour vendredi. (el dwa aprandr set poezi pur vandredi) - Deve imparare questa poesia per venerdì.
Le cours a été annulé parce que le professeur est malade. (le kur a été anüle parskö le profesör é malad) - La lezione è stata annullata perché l'insegnante è malato.
Tu peux poser ton sac ici, mais ne le laisse pas dans le passage. (tü pö poze ton sak isi, mè ne le les pa dan le pasaʒ) - Puoi mettere la borsa qui, ma non lasciarla nel passaggio.
Je te laisse dix minutes pour finir, pas davantage. (ʒö te les dis minüt pur finir, pa davantaʒ) - Ti lascio dieci minuti per finire, non di più.
Tu peux aller chez ton ami après avoir terminé tes devoirs. (tü pö ale sce ton ami aprè avwar terminé te devwar) - Puoi andare dal tuo amico dopo aver finito i compiti.
Je veux juste que tu respectes l'heure qu'on a fixée. (ʒö vö ʒüst ke tü respekt lör kon a fikse) - Voglio solo che tu rispetti l'orario che abbiamo stabilito.
Demain matin, tout le monde se lève à la même heure. (döman maten, tu le mond se lèv a la mem ör) - Domani mattina tutti si alzano alla stessa ora.
J'ai pris un médicament avant de me coucher. (ʒé pri an medikaman avan de me kusce) - Ho preso un farmaco prima di andare a letto.
La douleur s'est calmée après quelques minutes. (la dulör sé kalmé aprè kelk minüt) - Il dolore si è calmato dopo alcuni minuti.
Je vais demander au pharmacien s'il existe une version moins chère. (ʒö vé demandé o farmasièn sil egzist ün versiòn mwan scèr) - Chiederò al farmacista se esiste una versione meno costosa.
Le médecin veut refaire une analyse dans quelques semaines. (le medsan vö refèr ün analiz dan kelk semèn) - Il medico vuole ripetere un'analisi tra qualche settimana.
J'ai oublié mon téléphone dans le train, mais je l'ai récupéré à la gare suivante. (ʒé oublié mon telefon dan le tran, mè ʒö lé re küpere a la gar süivant) - Ho dimenticato il telefono sul treno, ma l'ho recuperato alla stazione successiva.
Le contrôleur m'a demandé de présenter mon billet. (le kontrolör ma demandé de prezante mon biyè) - Il controllore mi ha chiesto di mostrare il biglietto.
On a trouvé deux places libres juste à côté de la porte. (on a truvé dö plas libr ʒüst a kote de la port) - Abbiamo trovato due posti liberi proprio accanto alla porta.
Le train est arrivé à l'heure malgré le retard annoncé. (le tran é arivé a lör malgre le retar anonse) - Il treno è arrivato in orario nonostante il ritardo annunciato.
J'ai validé ma carte avant de franchir les portiques. (ʒé valide ma kart avan de franscir le portik) - Ho convalidato la mia tessera prima di attraversare i tornelli.
La rame suivante sera moins chargée, attends une minute. (la ram süivant sera mwan sciarge, atand ün minüt) - Il convoglio successivo sarà meno affollato, aspetta un minuto.
Je ne sais pas quelle sortie prendre pour la mairie. (ʒö ne sè pa kel sorti prandr pur la meri) - Non so quale uscita prendere per il municipio.
Le bus a été dévié pendant toute la matinée. (le büs a été devié pandan tut la matiné) - L'autobus è stato deviato per tutta la mattina.
J'ai laissé passer le bus parce qu'il était déjà plein. (ʒé lesé pasé le büs parskil etè deʒa plen) - Ho lasciato passare l'autobus perché era già pieno.
Le chauffeur a freiné brusquement pour éviter un piéton. (le scöför a frené brüskman pur evité an pieton) - L'autista ha frenato bruscamente per evitare un pedone.
J'ai vérifié la porte d'embarquement avant de m'asseoir. (ʒé verifié la port danbarkman avan de maswar) - Ho controllato il gate d'imbarco prima di sedermi.
On doit passer par les bornes automatiques pour imprimer les étiquettes. (on dwa pasé par le born otomatik pur anprimé lez etikèt) - Dobbiamo passare dai chioschi automatici per stampare le etichette.
J'ai mis mon passeport dans une poche facile d'accès. (ʒé mi mon paspor dan ün posc fasil dakse) - Ho messo il passaporto in una tasca facilmente accessibile.
Le commandant a annoncé quelques turbulences pendant le vol. (le komandã a anonse kelk türbülans pandan le vol) - Il comandante ha annunciato alcune turbolenze durante il volo.
La mer est calme aujourd'hui, la traversée devrait être agréable. (la mer é kalm oʒurdüi, la traversé dövrè etr agreabl) - Oggi il mare è calmo, la traversata dovrebbe essere piacevole.
On doit rejoindre le bateau avant la fermeture de l'embarquement. (on dwa reʒwèndr le bato avan la fermetür de lanbarkman) - Dobbiamo raggiungere il traghetto prima della chiusura dell'imbarco.
Pour aller à la cathédrale, continue jusqu'à la deuxième rue. (pur alé a la katedral, kontinü ʒüsk a la dözyèm rü) - Per andare alla cattedrale, continua fino alla seconda strada.
Je me suis orienté grâce au clocher qu'on voit de loin. (ʒö me süi orienté gras o klosce kon vwa de lwan) - Mi sono orientato grazie al campanile che si vede da lontano.
J'ai trouvé une place gratuite à quelques rues d'ici. (ʒé truvé ün plas gratüit a kelk rü disi) - Ho trovato un posto gratuito a poche strade da qui.
Le garagiste pense que le problème vient de l'alternateur. (le garagist pans ke le problem vien de lalternatör) - Il meccanico pensa che il problema venga dall'alternatore.
J'ai laissé la voiture au garage pour la journée. (ʒé lesé la vuatür o garaʒ pur la ʒurné) - Ho lasciato la macchina dal meccanico per tutta la giornata.
Le dépanneur m'a demandé ma position exacte. (le depanör ma demandé ma pozisiòn egzakt) - Il soccorso stradale mi ha chiesto la mia posizione esatta.
La circulation est redevenue normale après l'accident. (la sirkülasiòn é redevenü normal aprè laksidan) - Il traffico è tornato normale dopo l'incidente.
Les travaux sur le pont devraient se terminer vendredi. (le travay sür le pon dövrè se terminé vandredi) - I lavori sul ponte dovrebbero terminare venerdì.
Il n'y a plus d'eau chaude dans tout l'immeuble. (il nia plü do scod dan tu limöbl) - Non c'è più acqua calda in tutto il palazzo.
Le propriétaire a envoyé un technicien pour réparer la chaudière. (le proprietèr a anvwaye an teknisièn pur reparé la scodier) - Il proprietario ha mandato un tecnico per riparare la caldaia.
...
J'ai rangé les produits ménagers sous l'évier pour libérer de la place. (ʒé ranʒé le prodüi menaʒer su levié pur libere de la plas) - Ho sistemato i prodotti per la pulizia sotto il lavello per fare spazio.
Tu peux secouer le tapis dehors avant de le remettre ? (tü pö seküé le tapi deor avan de le remetr) - Puoi scuotere il tappeto fuori prima di rimetterlo?
J'ai fermé toutes les fenêtres avant de quitter la maison. (ʒé fermé tut le fenetr avan de kite la mezon) - Ho chiuso tutte le finestre prima di uscire di casa.
Le frigo fait un drôle de bruit depuis hier soir. (le frigo fè an drol de brüi döpüi ier swar) - Il frigorifero fa uno strano rumore da ieri sera.
Le chien s'est couché près de la porte d'entrée. (le scièn sé kusce prè de la port dantré) - Il cane si è sdraiato vicino alla porta d'ingresso.
J'ai acheté des croquettes que le chat semble beaucoup aimer. (ʒé asciété de krokèt ke le scia sambl bokou emé) - Ho comprato dei croccantini che al gatto sembrano piacere molto.
J'ai pris un bol de céréales avant de partir au travail. (ʒé pri an bol de seréal avan de partir o travay) - Ho mangiato una ciotola di cereali prima di andare al lavoro.
Tu peux mettre le jus d'orange au réfrigérateur ? (tü pö metr le ʒü doranʒ o refrigératör) - Puoi mettere il succo d'arancia in frigorifero?
On a mangé assez tôt parce que tout le monde était fatigué. (on a manʒé ase to parskö tu le mond etè fatigué) - Abbiamo cenato abbastanza presto perché erano tutti stanchi.
J'ai goûté la sauce, elle manque un peu de sel. (ʒé gute la sos, el mank an pö de sel) - Ho assaggiato il sugo, manca un po' di sale.
J'ai oublié de mettre mon nom sur la feuille. (ʒé oublié de metr mon nom sür la föy) - Ho dimenticato di mettere il mio nome sul foglio.
Le professeur a corrigé mes fautes avec beaucoup de patience. (le profesör a koreʒé me fot avek bokou de pasyans) - L'insegnante ha corretto i miei errori con molta pazienza.
Elle a choisi cette matière parce qu'elle la trouve intéressante. (el a scwazì set materyèr parskel la truv antèresant) - Ha scelto questa materia perché la trova interessante.
J'ai encore trois pages à lire pour demain. (ʒé ankor trwa paʒ a lir pur döman) - Ho ancora tre pagine da leggere per domani.
Le contrôle de demain porte sur le dernier chapitre. (le kontrol de döman port sür le dernie scapitər) - La verifica di domani riguarda l'ultimo capitolo.
Tu peux poser ton téléphone pendant que tu fais tes devoirs ? (tü pö poze ton telefon pandan ke tü fè te devwar) - Puoi mettere via il telefono mentre fai i compiti?
Je préfère que tu me dises directement quand il y a un problème. (ʒö prefer ke tü me diz direktman kan il ia an problem) - Preferisco che tu mi dica direttamente quando c'è un problema.
Tu peux rester chez ton ami jusqu'à vingt-deux heures. (tü pö reste sce ton ami ʒüsk a van dö ör) - Puoi restare dal tuo amico fino alle ventidue.
Je veux juste un message quand tu arrives sur place. (ʒö vö ʒüst an mesaʒ kan tü ariv sür plas) - Voglio solo un messaggio quando arrivi sul posto.
Après dix heures, on évite de faire du bruit. (aprè dis ör, on evit de fer dü brüi) - Dopo le dieci evitiamo di fare rumore.
J'ai mal au dos depuis que j'ai porté cette caisse. (ʒé mal o do döpüi ke ʒé porte set kès) - Mi fa male la schiena da quando ho portato questa cassa.
La pharmacienne m'a conseillé de prendre les comprimés pendant les repas. (la farmasièn ma konsèyé de prandr le komprimé pandan le repa) - La farmacista mi ha consigliato di prendere le compresse durante i pasti.
Je me sens beaucoup mieux après avoir dormi. (ʒö me san bokou miö aprè avwar dormi) - Mi sento molto meglio dopo aver dormito.
Le médecin a dit qu'il fallait surveiller la température. (le medsan a di kil falè sürveyé la tanperatür) - Il medico ha detto che bisogna controllare la temperatura.
J'ai une ordonnance à faire renouveler. (ʒé ün ordonans a fer renüvelé) - Ho una ricetta da rinnovare.
Le train est parti juste avant qu'on arrive sur le quai. (le tran é parti ʒüst avan kon ariv sür le ké) - Il treno è partito proprio prima che arrivassimo al binario.
J'ai pris un billet flexible au cas où mes plans changeraient. (ʒé pri an biyè fleksibl o ka u me plan sciandʒré) - Ho preso un biglietto flessibile nel caso cambiassero i miei programmi.
On a trouvé un compartiment assez tranquille. (on a truvé an kompartiman ase trankil) - Abbiamo trovato uno scompartimento abbastanza tranquillo.
Le contrôleur passera bientôt, garde ton billet à portée de main. (le kontrolör pasar biènto, gard ton biyè a porte de men) - Il controllore passerà presto, tieni il biglietto a portata di mano.
La ligne est interrompue entre ces deux stations. (la liñ é anterompü antr se dö stasiòn) - La linea è interrotta tra queste due stazioni.
J'ai pris la mauvaise sortie et je me suis retrouvé à l'autre bout du quartier. (ʒé pri la movèz sorti é ʒö me süi retruvé a lotr bu dü kartié) - Ho preso l'uscita sbagliata e mi sono ritrovato dall'altra parte del quartiere.
Les escaliers mécaniques sont en panne. (le zekalye mekanik son an pan) - Le scale mobili sono guaste.
On a laissé passer deux métros avant de pouvoir monter. (on a lesé pasé dö métro avan de puvar monte) - Abbiamo lasciato passare due metropolitane prima di poter salire.
Le bus suivant s'arrête devant le marché. (le büs süivan sarèt devan le marsce) - Il prossimo autobus si ferma davanti al mercato.
J'ai regardé l'itinéraire sur mon téléphone pendant le trajet. (ʒé regardé litinerèr sür mon telefon pandan le traʒè) - Ho guardato il percorso sul telefono durante il tragitto.
Le chauffeur a annoncé un détour à cause d'une rue fermée. (le scöför a anonse an detur a koz dün rü fermé) - L'autista ha annunciato una deviazione a causa di una strada chiusa.
J'ai imprimé les documents nécessaires avant de partir pour l'aéroport. (ʒé anprimé le doküman neseser avan de partir pur laeroport) - Ho stampato i documenti necessari prima di partire per l'aeroporto.
On a eu un contrôle supplémentaire avant d'entrer dans l'avion. (on a ü an kontrol süplemantèr avan dantré dan laviyon) - Abbiamo avuto un controllo supplementare prima di salire sull'aereo.
J'ai demandé à l'hôtesse si je pouvais changer de siège. (ʒé demandé a lotès si ʒö puvè sciandʒé de sièʒ) - Ho chiesto all'assistente di volo se potevo cambiare posto.
Le pilote a annoncé notre arrivée avec quelques minutes d'avance. (le pilot a anonse notr arivé avek kelk minüt davans) - Il pilota ha annunciato il nostro arrivo con qualche minuto di anticipo.
On a réservé une cabine pour pouvoir dormir pendant la traversée. (on a rezervé ün kabin pur puvar dormi pandan la traversé) - Abbiamo prenotato una cabina per poter dormire durante la traversata.
J'ai demandé où se trouvait la billetterie du port. (ʒé demandé u se truvè la biyetri dü por) - Ho chiesto dove si trovasse la biglietteria del porto.
Pour rejoindre le centre, tu peux suivre la rivière. (pur reʒwèndr le santr, tü pö süivr la rivyèr) - Per raggiungere il centro puoi seguire il fiume.
Je pensais que cette rue menait directement à la gare. (ʒö pansè ke set rü menè direktman a la gar) - Pensavo che questa strada portasse direttamente alla stazione.
La voiture ne démarre plus depuis ce matin. (la vuatür ne demar plü döpüi se maten) - La macchina non parte più da stamattina.
J'ai entendu un claquement quand j'ai tourné le volant. (ʒé antandü an klakman kan ʒé turné le volan) - Ho sentito uno scatto quando ho girato il volante.
Le garage m'a dit que la réparation prendra deux jours. (le garaʒ ma di ke la reparasiòn prandra dö ʒur) - L'officina mi ha detto che la riparazione richiederà due giorni.
La route est glissante après cette pluie. (la rut é glisant aprè set plüi) - La strada è scivolosa dopo questa pioggia.
Il y a des travaux partout dans le centre-ville. (il ia de travay partu dan le santr-vil) - Ci sono lavori ovunque in centro.
Une alerte météo a été diffusée sur les téléphones. (ün alèrt meteo a été diffüze sür le telefon) - Un'allerta meteo è stata diffusa sui telefoni.
...
J'ai nettoyé les vitres du salon parce qu'elles étaient pleines de traces. (ʒé netwaye le vitr dü salon parskel etè plen de tras) - Ho pulito i vetri del salotto perché erano pieni di aloni.
Tu peux vider la poubelle avant de partir ? (tü pö vide la pubel avan de partir) - Puoi svuotare la spazzatura prima di uscire?
J'ai étendu le linge sur le balcon, il devrait sécher rapidement. (ʒé etandü le liñ sür le balkon, il dövrè se sce rapidman) - Ho steso il bucato sul balcone, dovrebbe asciugarsi rapidamente.
La porte d'entrée coince quand on essaie de la fermer. (la port dantré kwans kan on esè de la ferme) - La porta d'ingresso si inceppa quando si cerca di chiuderla.
Le chat s'est caché sous le lit dès qu'il a entendu du bruit. (le scia sé kascé su le li dès kil a antandü dü brüi) - Il gatto si è nascosto sotto il letto appena ha sentito un rumore.
Le chien attend devant sa gamelle depuis tout à l'heure. (le scièn atand devan sa gamel döpüi tu a lör) - Il cane aspetta davanti alla sua ciotola da un po'.
J'ai pris une douche rapide parce que j'étais déjà en retard. (ʒé pri ün dusc rapid parskö ʒetè deʒa an retar) - Ho fatto una doccia veloce perché ero già in ritardo.
Tu peux couper le pain pendant que je prépare le café ? (tü pö küpe le pan pandan ke ʒö prepar le kafé) - Puoi tagliare il pane mentre preparo il caffè?
On a décidé de manger dehors puisqu'il fait encore doux. (on a dezide de manʒé deor püiskil fè ankor du) - Abbiamo deciso di mangiare fuori visto che fa ancora mite.
J'ai préparé une salade légère pour accompagner le poisson. (ʒé preparé ün salad leʒèr pur akonpañé le pwasòn) - Ho preparato un'insalata leggera per accompagnare il pesce.
J'ai oublié mon agenda à la maison ce matin. (ʒé oublié mon aʒanda a la mezon se maten) - Ho dimenticato la mia agenda a casa stamattina.
La classe doit rendre le projet avant la fin du mois. (la klas dwa randr le proʒè avan la fen dü mwa) - La classe deve consegnare il progetto entro la fine del mese.
Elle a passé l'interrogation sans aucune difficulté. (el a pase lanterogasiòn san okün difikülte) - Ha superato l'interrogazione senza alcuna difficoltà.
J'ai demandé au professeur si je pouvais refaire l'exercice. (ʒé demandé o profesör si ʒö puvè refèr legzèrsis) - Ho chiesto all'insegnante se potevo rifare l'esercizio.
Il a laissé son cahier ouvert sur la table de la cuisine. (il a lesé son kayé uver sür la tabl de la küizin) - Ha lasciato il quaderno aperto sul tavolo della cucina.
Tu peux m'appeler quand tu as fini ton entraînement ? (tü pö maplé kan tü a fini ton antrènman) - Puoi chiamarmi quando hai finito il tuo allenamento?
Je préfère que tu rentres avant que la nuit tombe. (ʒö prefer ke tü rantr avan ke la nüi tomb) - Preferisco che tu rientri prima che faccia buio.
Ce week-end, tu peux inviter deux amis à la maison. (se wik-end, tü pö anvité dö zami a la mezon) - Questo fine settimana puoi invitare due amici a casa.
N'oublie pas de prévenir si tes plans changent. (nübli pa de prevenir si te plan sciandʒ) - Non dimenticare di avvisare se cambiano i tuoi programmi.
J'ai la gorge irritée depuis hier. (ʒé la gor iʁité döpüi ier) - Ho la gola irritata da ieri.
Le pharmacien m'a conseillé un sirop pour la toux. (le farmasièn ma konsèyé an siro pur la tu) - Il farmacista mi ha consigliato uno sciroppo per la tosse.
Je vais rester au repos jusqu'à ce que ça aille mieux. (ʒö vé resté o repo ʒüsk a se sa ay miö) - Rimarrò a riposo finché non starò meglio.
Le médecin m'a demandé depuis combien de temps j'avais ces symptômes. (le medsan ma demandé döpüi kombièn de tan ʒavè se simptòm) - Il medico mi ha chiesto da quanto tempo avessi questi sintomi.
J'ai oublié de prendre ma carte Vitale. (ʒé oublié de prandr ma kart vital) - Ho dimenticato di prendere la tessera sanitaria.
On nous a annoncé un retard de quinze minutes. (on nu a anonse an retar de kanz minüt) - Ci hanno annunciato un ritardo di quindici minuti.
J'ai acheté mon billet directement au distributeur. (ʒé asciété mon biyè direktman o distribütör) - Ho comprato il biglietto direttamente alla macchinetta.
Le train ralentit avant d'entrer dans la gare. (le tran ralentì avan dantré dan la gar) - Il treno rallenta prima di entrare in stazione.
On a changé de quai au dernier moment. (on a sciandʒé de ké o dernie moman) - Abbiamo cambiato binario all'ultimo momento.
La sortie du métro donne directement sur la place principale. (la sorti dü métro don direktman sür la plas prinsipal) - L'uscita della metropolitana porta direttamente sulla piazza principale.
J'ai attendu plusieurs minutes avant de trouver une rame moins remplie. (ʒé atandü plüzior minüt avan de truvé ün ram mwan ranpli) - Ho aspettato diversi minuti prima di trovare un convoglio meno affollato.
Tu dois appuyer sur le bouton pour ouvrir les portes. (tü dwa apüiyé sür le buton pur uvrir le port) - Devi premere il pulsante per aprire le porte.
Le bus est passé sans s'arrêter parce qu'il était complet. (le büs é pase san sarete parskil etè komplet) - L'autobus è passato senza fermarsi perché era pieno.
J'ai regardé le panneau pour vérifier le numéro de la ligne. (ʒé regardé le pano pur verifié le nümero de la liñ) - Ho guardato il cartello per controllare il numero della linea.
Le chauffeur a attendu une personne qui courait vers l'arrêt. (le scöför a atandü ün person ki kurè ver larè) - L'autista ha aspettato una persona che correva verso la fermata.
Je préfère enregistrer mon bagage en soute pour voyager plus léger. (ʒö prefer anreʒistré mon bagàʒ an sut pur vwayaʒé plü leʒé) - Preferisco imbarcare il bagaglio in stiva per viaggiare più leggero.
On doit retirer les ordinateurs du sac au contrôle de sécurité. (on dwa retiré le zordinatör dü sak o kontrol de sekürité) - Dobbiamo togliere i computer dalla borsa ai controlli di sicurezza.
J'ai vérifié le poids de ma valise avant de partir. (ʒé verifié le pwa de ma valiz avan de partir) - Ho controllato il peso della mia valigia prima di partire.
L'avion a décollé avec environ vingt minutes de retard. (laviyon a dekole avek anviron van minüt de retar) - L'aereo è decollato con circa venti minuti di ritardo.
La mer est agitée, le bateau risque de bouger davantage. (la mer é aʒité, le bato risk de buʒé davantaʒ) - Il mare è agitato, il traghetto rischia di muoversi ancora di più.
J'ai gardé le billet du ferry dans mon portefeuille. (ʒé gardé le biyè dü feri dan mon portföy) - Ho conservato il biglietto del traghetto nel portafoglio.
On peut voir le phare depuis le pont du bateau. (on pö vwar le far döpüi le pon dü bato) - Si può vedere il faro dal ponte del traghetto.
Pour aller au musée, prends la rue parallèle à celle-ci. (pur alé o müze, pran la rü paralèl a sel-si) - Per andare al museo, prendi la strada parallela a questa.
J'ai demandé à un passant de m'indiquer le chemin. (ʒé demandé a an pasan de mandike le sciaman) - Ho chiesto a un passante di indicarmi la strada.
Le GPS nous fait passer par une route beaucoup plus longue. (le ʒepe-es nu fè pasé par ün rut bokou plü long) - Il GPS ci fa passare da una strada molto più lunga.
La batterie de la voiture est complètement à plat. (la batri de la vuatür é komèteman a pla) - La batteria della macchina è completamente scarica.
J'ai appelé l'assistance parce que je n'arrivais plus à démarrer. (ʒé apel lasistans parskö ʒö narivè plü a demaré) - Ho chiamato l'assistenza perché non riuscivo più a mettere in moto la macchina.
Une voiture a bloqué l'accès au parking. (ün vuatür a bloke lakse o parking) - Un'auto ha bloccato l'accesso al parcheggio.
Le feu tricolore ne fonctionne plus depuis ce matin. (le fö trikolor ne fonksiòn plü döpüi se maten) - Il semaforo non funziona più da stamattina.
Les pompiers sont intervenus rapidement après le signalement. (le pompye son antervenü rapidman aprè le siñalman) - I vigili del fuoco sono intervenuti rapidamente dopo la segnalazione.
La rue est inondée, mieux vaut prendre un autre chemin. (la rü é inonde, miö vo prandr an otr sciaman) - La strada è allagata, è meglio prendere un'altra strada.
La connexion Wi-Fi est devenue très lente depuis hier. (la koneksiòn wifi é devenü trè lant döpüi ier) - La connessione Wi-Fi è diventata molto lenta da ieri.
La réception m'a proposé de changer de chambre. (la resepsiòn ma propozé de sciandʒé de sciambre) - La reception mi ha proposto di cambiare camera.
J'ai demandé une couverture supplémentaire parce que j'avais froid. (ʒé demandé ün kuvèrtür süplemantèr parskö ʒavè frwa) - Ho chiesto una coperta aggiuntiva perché avevo freddo.
L'hôte nous a expliqué comment utiliser la serrure connectée. (lot nu a eksplike koman ütilizé la serür konekté) - L'host ci ha spiegato come usare la serratura smart.
J'ai lancé une lessive avant de partir faire les courses. (ʒé lanse ün lesiv avan de partir fer le kurs) - Ho fatto partire una lavatrice prima di uscire a fare la spesa.
Tu peux remettre les chaussures dans le meuble de l'entrée ? (tü pö remetr le scosür dan le möbl de lantré) - Puoi rimettere le scarpe nel mobile dell'ingresso?
J'ai nettoyé la table avec un chiffon humide. (ʒé netwaye la tabl avek an scifon ümide) - Ho pulito il tavolo con un panno umido.
La clé de la boîte aux lettres est restée sur la serrure. (la clé de la bwat o letr é resté sür la serür) - La chiave della cassetta delle lettere è rimasta nella serratura.
Le chien s'est endormi juste à côté de mes pieds. (le scièn sé andormi ʒüst a kote de me pye) - Il cane si è addormentato proprio accanto ai miei piedi.
Notre chat n'aime pas quand on ferme la porte de la chambre. (notr scia nem pa kan on ferm la port de la sciambre) - Al nostro gatto non piace quando chiudiamo la porta della camera.
J'ai préparé des œufs brouillés avec des tomates. (ʒé preparé de zö bruïé avek de tomat) - Ho preparato delle uova strapazzate con i pomodori.
Tu veux du pain frais avec ton fromage ? (tü vö dü pan frè avek ton fromaʒ) - Vuoi del pane fresco con il tuo formaggio?
On garde les restes au frigo pour le déjeuner de demain. (on gard le rest o frigo pur le deʒöné de döman) - Conserviamo gli avanzi in frigo per il pranzo di domani.
J'ai mis la soupe à chauffer pendant qu'on mettait la table. (ʒé mi la sup a scofé pandan kon metè la tabl) - Ho messo la zuppa a scaldare mentre apparecchiavamo.
J'ai commencé mes devoirs dès que je suis rentré. (ʒé komanse me devwar de ke ʒö süi rantré) - Ho iniziato i compiti appena sono tornato.
La prof nous a donné jusqu'à lundi pour rendre le travail. (la prof nu a doné ʒüsk a landi pur randr le travay) - La professoressa ci ha dato tempo fino a lunedì per consegnare il lavoro.
J'ai beaucoup aimé le cours d'histoire aujourd'hui. (ʒé bokou emé le kur distwar oʒurdüi) - Mi è piaciuta molto la lezione di storia oggi.
Il a besoin d'aide pour comprendre cette équation. (il a bezwan ded pur komprandr set eküasiòn) - Ha bisogno di aiuto per capire questa equazione.
J'ai laissé mon dictionnaire dans mon casier. (ʒé lesé mon diksionèr dan mon kazié) - Ho lasciato il mio dizionario nell'armadietto.
Tu ferais mieux de préparer ton sac ce soir. (tü ferè miö de preparé ton sak se swar) - Faresti meglio a preparare la tua borsa stasera.
Je ne veux pas que tu utilises mon ordinateur sans me demander. (ʒö ne vö pa ke tü ütiliz mon ordinatör san me demandé) - Non voglio che tu usi il mio computer senza chiedermelo.
Tu peux regarder un épisode, mais après tu vas te coucher. (tü pö regardé an epizod, mè aprè tü va te kusce) - Puoi guardare un episodio, ma dopo vai a letto.
Si tu sors, prends une veste, il va faire frais ce soir. (si tü sor, pran ün vest, il va fer frè se swar) - Se esci, porta una giacca, stasera farà fresco.
On se retrouve tous à table à huit heures. (on se retruv tu a tabl a üit ör) - Ci ritroviamo tutti a tavola alle otto.
J'ai les yeux qui me piquent depuis ce matin. (ʒé lez yö ki me pik döpüi se maten) - Ho gli occhi che mi bruciano da stamattina.
La pharmacienne m'a demandé si j'étais allergique à certains médicaments. (la farmasièn ma demandé si ʒetè alergik a serten medikaman) - La farmacista mi ha chiesto se ero allergico ad alcuni farmaci.
Je vais boire davantage d'eau pendant quelques jours. (ʒö vé bwar davantaʒ do pandan kelk ʒur) - Berrò più acqua per qualche giorno.
Le médecin a vérifié ma tension avant de me laisser partir. (le medsan a verifie ma tansiòn avan de me lesé partir) - Il medico ha controllato la mia pressione prima di lasciarmi andare.
J'ai pris rendez-vous en ligne pour éviter d'attendre au téléphone. (ʒé pri randé-vu an liñ pur evité datandr o telefon) - Ho preso appuntamento online per evitare di aspettare al telefono.
J'ai réservé une place côté fenêtre pour le trajet. (ʒé rezervé ün plas kote fenetr pur le traʒè) - Ho prenotato un posto vicino al finestrino per il viaggio.
Le train entre en gare dans moins de cinq minutes. (le tran antr an gar dan mwan de sank minüt) - Il treno entra in stazione tra meno di cinque minuti.
On a raté notre correspondance à cause du retard. (on a rate notr korespondans a koz dü retar) - Abbiamo perso la coincidenza a causa del ritardo.
J'ai mis ma valise sur le porte-bagages au-dessus du siège. (ʒé mi ma valiz sür le port-bagàʒ o-desü dü sièʒ) - Ho messo la valigia sul portabagagli sopra il sedile.
La gare est presque vide à cette heure du matin. (la gar é presk vid a set ör dü maten) - La stazione è quasi vuota a quest'ora del mattino.
Je dois sortir à la prochaine station, sinon je vais trop loin. (ʒö dwa sortir a la proscièn stasiòn, sinon ʒö vé tro lwan) - Devo scendere alla prossima stazione, altrimenti vado troppo lontano.
La rame est arrivée sur le quai opposé. (la ram é arivé sür le ké opozé) - Il convoglio è arrivato sul binario opposto.
J'ai rechargé ma carte de transport avant de prendre le métro. (ʒé rescarʒé ma kart de transport avan de prandr le métro) - Ho ricaricato la mia tessera dei trasporti prima di prendere la metropolitana.
Le bus passe toutes les quinze minutes pendant la journée. (le büs pas tut le kanz minüt pandan la ʒurné) - L'autobus passa ogni quindici minuti durante il giorno.
J'ai demandé à une dame si elle savait où se trouvait l'arrêt. (ʒé demandé a ün dam si el savè u se truvè larè) - Ho chiesto a una signora se sapesse dove si trovava la fermata.
On prendra le bus suivant, celui-ci est trop chargé. (on prandra le büs süivan, selüi-si é tro sciarsce) - Prenderemo l'autobus successivo, questo è troppo affollato.
Le conducteur a dû s'arrêter à cause d'un obstacle sur la chaussée. (le kondüktör a dü sarete a koz dan obstakl sür la scose) - Il conducente ha dovuto fermarsi a causa di un ostacolo sulla carreggiata.
J'ai enregistré le vol sur mon application de voyage. (ʒé anreʒistré le vol sür mon aplikasiòn de vwayaʒ) - Ho salvato il volo sulla mia app di viaggio.
Les passagers doivent rester assis jusqu'à l'arrêt complet de l'avion. (le pasajé dwav resté asi ʒüsk a larè komplet de laviyon) - I passeggeri devono rimanere seduti fino al completo arresto dell'aereo.
J'ai dû mettre ma veste dans mon bagage à main. (ʒé dü metr ma vest dan mon bagàʒ a men) - Ho dovuto mettere la mia giacca nel bagaglio a mano.
On attend encore l'autorisation de commencer l'embarquement. (on atand ankor lotorizasiòn de komansé lanbarkman) - Stiamo ancora aspettando l'autorizzazione a iniziare l'imbarco.
Le ferry partira dès que tous les véhicules seront à bord. (le feri partira de ke tu le vekül seron a bor) - Il traghetto partirà non appena tutti i veicoli saranno a bordo.
J'ai acheté un billet aller-retour au guichet du port. (ʒé asciété an biyè alé-retur o giscè dü por) - Ho comprato un biglietto di andata e ritorno alla biglietteria del porto.
La traversée dure environ deux heures et demie. (la traversé dür anviron dö ör é dömi) - La traversata dura circa due ore e mezza.
Pour aller à la bibliothèque, tourne à gauche après le feu. (pur alé a la bibliyotèk, turn a gos aprè le fö) - Per andare in biblioteca, gira a sinistra dopo il semaforo.
Le quartier historique commence juste derrière cette place. (le kartié istorik komans ʒüst derrièr set plas) - Il quartiere storico comincia proprio dietro questa piazza.
J'ai noté l'adresse sur un morceau de papier au cas où. (ʒé note ladres sür an morso de papié o ka u) - Ho annotato l'indirizzo su un pezzo di carta, non si sa mai.
Le volant tremble quand je dépasse les quatre-vingts kilomètres à l'heure. (le volan trambl kan ʒö depas le katr-van kilomet a lör) - Il volante trema quando supero gli ottanta chilometri orari.
J'ai appelé mon assurance juste après l'accrochage. (ʒé apel mon asürans ʒüst aprè lakroscaʒ) - Ho chiamato la mia assicurazione subito dopo il piccolo incidente.
Le dépanneur devrait arriver d'ici une demi-heure. (le depanör dövrè arivé disi ün dömi ör) - Il soccorso stradale dovrebbe arrivare entro mezz'ora.
Il y a des bouchons depuis la sortie de l'autoroute. (il ia de buson döpüi la sorti de lotorut) - C'è traffico intenso dall'uscita dell'autostrada.
La rue a été fermée parce qu'une canalisation a éclaté. (la rü a été fermé parskün kanalizasiòn a eklaté) - La strada è stata chiusa perché è scoppiata una tubatura.
Le personnel de l'hôtel m'a prêté un adaptateur électrique. (le personel de lotèl ma prete an adaptatör elektrik) - Il personale dell'hotel mi ha prestato un adattatore elettrico.
La douche fuit et l'eau s'accumule sur le sol. (la dusc füi é lo sakümül sür le sol) - La doccia perde e l'acqua si accumula sul pavimento.
J'ai changé les draps et aéré la chambre pendant quelques minutes. (ʒé sciandʒé le dra é are la sciambre pandan kelk minüt) - Ho cambiato le lenzuola e arieggiato la camera per qualche minuto.
Tu peux passer un coup de balai dans l'entrée ? (tü pö pasé an ku de balè dan lantré) - Puoi dare una spazzata all'ingresso?
J'ai mis les vêtements délicats à sécher à l'intérieur. (ʒé mi le vetman delika a se sce a linteriör) - Ho messo ad asciugare in casa i vestiti delicati.
La télécommande n'a presque plus de piles. (la teleromand na presk plü de pil) - Il telecomando ha quasi esaurito le batterie.
Le chat miaule devant la porte du balcon. (le scia myol devan la port dü balkon) - Il gatto miagola davanti alla porta del balcone.
J'ai réservé une visite chez le vétérinaire pour mardi prochain. (ʒé rezervé ün vizit sce le veteriner pur mardi proscièn) - Ho prenotato una visita dal veterinario per martedì prossimo.
J'ai pris un café et une banane avant de sortir. (ʒé pri an kafé é ün banan avan de sortir) - Ho preso un caffè e una banana prima di uscire.
Tu peux couper les fruits pour le dessert ? (tü pö küpe le frui pur le deser) - Puoi tagliare la frutta per il dolce?
On mangera plus tard, j'attends encore ma fille. (on manʒra plü tar, ʒatand ankor ma fiʒ) - Mangeremo più tardi, sto ancora aspettando mia figlia.
J'ai sorti le pain du congélateur pour ce soir. (ʒé sorti le pan dü konʒelatör pur se swar) - Ho tirato fuori il pane dal congelatore per stasera.
J'ai terminé mon devoir de littérature hier soir. (ʒé terminé mon devwar de literatür ier swar) - Ho finito il mio compito di letteratura ieri sera.
La classe prépare une sortie scolaire pour le mois prochain. (la klas prepar ün sorti skolèr pur le mwa proscièn) - La classe sta preparando una gita scolastica per il mese prossimo.
J'ai reçu les résultats de mon contrôle par l'application de l'école. (ʒé resü le rezultà de mon kontrol par laplikasiòn de lekol) - Ho ricevuto i risultati della mia verifica tramite l'app della scuola.
Elle préfère travailler le matin quand la maison est calme. (el prefer travayé le maten kan la mezon é kalm) - Preferisce studiare la mattina quando la casa è tranquilla.
Le professeur a demandé aux élèves de former des groupes. (le profesör a demandé ozelèv de formé de grup) - L'insegnante ha chiesto agli studenti di formare dei gruppi.
Tu dois ranger ta chambre avant de sortir avec tes amis. (tü dwa ranʒé ta sciambre avan de sortir avek tez ami) - Devi mettere in ordine la tua camera prima di uscire con gli amici.
Je t'autorise à utiliser la voiture, mais sois prudent. (ʒö totorìz a ütilizé la vuatür, mè swa prüdã) - Ti autorizzo a usare la macchina, ma fai attenzione.
Tu peux dormir un peu plus demain matin, c'est samedi. (tü pö dormi an pö plü döman maten, sè samedi) - Domani mattina puoi dormire un po' di più, è sabato.
Je veux que chacun participe aux tâches de la maison. (ʒö vö ke scakan partisip o tasce de la mezon) - Voglio che ognuno partecipi alle faccende di casa.
J'ai une petite irritation sur la peau depuis hier. (ʒé ün pətit iritasiòn sür la po döpüi ier) - Ho una piccola irritazione sulla pelle da ieri.
La pharmacienne m'a proposé une crème sans parfum. (la farmasièn ma propozé ün krem san parfum) - La farmacista mi ha proposto una crema senza profumo.
Je vais prendre ma température avant de décider. (ʒö vé prandr ma tanperatür avan de dezide) - Mi misurerò la temperatura prima di decidere.
Le médecin a écouté mes poumons avec son stéthoscope. (le medsan a ekuté me pümòn avek son stetoskop) - Il medico ha ascoltato i miei polmoni con lo stetoscopio.
On m'a conseillé de revenir si les symptômes s'aggravent. (on ma konsèyé de revnir si le simptòm saggrav) - Mi hanno consigliato di tornare se i sintomi peggiorano.
Le train est annoncé avec cinq minutes d'avance. (le tran é anonse avek sank minüt davans) - Il treno è annunciato con cinque minuti di anticipo.
J'ai demandé si ce billet était valable pour le train suivant. (ʒé demandé si se biyè etè valabl pur le tran süivan) - Ho chiesto se questo biglietto era valido per il treno successivo.
On s'est assis dans une voiture presque vide. (on sé asi danz ün vuatür presk vid) - Ci siamo seduti in una carrozza quasi vuota.
La gare routière est juste derrière la gare ferroviaire. (la gar rütyèr é ʒüst derrièr la gar feroviyèr) - La stazione degli autobus è proprio dietro quella ferroviaria.
J'ai oublié de composter mon billet avant de monter. (ʒé oublié de komposté mon biyè avan de monte) - Ho dimenticato di convalidare il biglietto prima di salire.
La sortie numéro six est beaucoup plus proche du centre. (la sorti nümero sis é bokou plü pros dü santr) - L'uscita numero sei è molto più vicina al centro.
Je suis descendu deux stations trop tôt. (ʒö süi desandü dö stasiòn tro to) - Sono sceso due fermate troppo presto.
La ligne est particulièrement chargée aux heures de pointe. (la liñ é partikülyèrman sciarsce o zer de pwant) - La linea è particolarmente affollata nelle ore di punta.
Le bus arrive dans trois minutes d'après l'écran. (le büs ariv dan trwa minüt daprè lekran) - L'autobus arriva tra tre minuti, secondo lo schermo.
J'ai oublié ma carte de transport dans l'autre veste. (ʒé oublié ma kart de transport dan lotr vest) - Ho dimenticato la tessera dei trasporti nell'altra giacca.
Le chauffeur nous a prévenus que le trajet serait plus long. (le scöför nu a prevnü ke le traʒè serè plü lon) - L'autista ci ha avvisato che il tragitto sarebbe stato più lungo.
Je préfère arriver tôt à l'aéroport plutôt que de courir. (ʒö prefer arivé to a laeroport plüto ke de kuri) - Preferisco arrivare presto in aeroporto piuttosto che correre.
Mon bagage dépasse légèrement la limite de poids autorisée. (mon bagàʒ depas leʒèrman la limit de pwa otorizé) - Il mio bagaglio supera leggermente il limite di peso consentito.
On a attendu presque une heure au contrôle de sécurité. (on a atandü presk ün ör o kontrol de sekürité) - Abbiamo aspettato quasi un'ora ai controlli di sicurezza.
J'ai demandé un siège côté couloir pour pouvoir me lever facilement. (ʒé demandé an sièʒ kote kuloir pur puvar me lev fasilman) - Ho chiesto un posto lato corridoio per potermi alzare facilmente.
Le vol a été retardé à cause des mauvaises conditions météo. (le vol a été retarde a koz de movèz kondisyon meteo) - Il volo è stato ritardato a causa delle cattive condizioni meteorologiche.
Le ferry accepte les voitures et les motos. (le feri aksèpt le vuatür é le moto) - Il traghetto accetta auto e moto.
J'ai regardé la météo avant de réserver la traversée. (ʒé regardé la meteo avan de rezervé la traversé) - Ho controllato il meteo prima di prenotare la traversata.
On doit suivre les indications jusqu'au parking du port. (on dwa süivr le zandikasiòn ʒüsk o parking dü por) - Dobbiamo seguire le indicazioni fino al parcheggio del porto.
Tourne à droite après la pharmacie et tu verras la fontaine. (turn a drwat aprè la farmasi é tü verà la fontèn) - Gira a destra dopo la farmacia e vedrai la fontana.
Je crois qu'on s'est trompés de direction. (ʒö krwa kon sé trompé de direksiòn) - Credo che abbiamo preso la direzione sbagliata.
Le GPS recalculera l'itinéraire si tu rates cette sortie. (le ʒepe-es rekalkülra litinerèr si tü rat set sorti) - Il GPS ricalcolerà il percorso se perdi questa uscita.
J'ai remarqué une fuite d'huile sous la voiture. (ʒé remarké ün füit düil su la vuatür) - Ho notato una perdita d'olio sotto la macchina.
Le pneu avant gauche perd de l'air depuis hier. (le pnö avan gos per de ler döpüi ier) - La gomma anteriore sinistra perde aria da ieri.
J'ai appelé l'assistance après avoir eu un voyant rouge au tableau de bord. (ʒé apel lasistans aprè avwar ü an vwayan ruʒ o tablo de bor) - Ho chiamato l'assistenza dopo che si è accesa una spia rossa sul cruscotto.
La circulation est bloquée dans les deux sens. (la sirkülasiòn é bloke dan le dö san) - Il traffico è bloccato in entrambe le direzioni.
Une coupure de courant a arrêté les feux de circulation. (ün kupür de kuran a arete le fö de sirkülasiòn) - Un'interruzione di corrente ha fermato i semafori.
